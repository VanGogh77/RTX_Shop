...
class MyProduct {
  static List<Product> allProducts = [
    ...
    Product(
      ...
      description: 'Жидкостная система охлаждения LIAN LI Galahad AIO UNI FAN SL Edition 240 – отличный выбор для владельцев игровых ПК и мощных универсальных компьютеров. ',
      price: 92.0,
      quantity: 1,
    ),
    Product(
      ...
      name: 'ZOOMFLOW 360X',
      category: 'Cooling',
      image: 'images/cooling/water3.png',
      description: 'Жидкостная система охлаждения ID-Cooling ZOOMFLOW 360X ARGB [LGA1700] оснащена 3-секционным алюминиевым радиатором, отличающимся высокой плотностью расположения пластин. ',
      price: 70.0,
      quantity: 1,
    ),
    Product(
      ...
      name: 'Alseye M90',
      category: 'Cooling',
      image: 'images/cooling/cooler.png',
      description: 'Alseye M90 эффективно и тихо охладит ваш процессор. ',
      price: 35.0,
      quantity: 1,
    ),
  ];
